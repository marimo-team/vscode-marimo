...
> [!Important]
> **We are actively rewriting this extension to provide a more native and robust experience**, similar to what you may be used to when using Jupyter in VS Code. **The new extension is being developed in**
> **[https://github.com/marimo-team/marimo-lsp](https://github.com/marimo-team/marimo-lsp), where new issues should be opened.** This repo is deprecated.
